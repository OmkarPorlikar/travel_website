...
const Header1 = () => {
  ...
  const navItems = [ '' ,  'Itinerary', 'Testimonials' , 'Contact'];

  return (
    <header
      className='fixed top-0 w-full z-50 transition-all duration-300 overflow-hidden bg-[#FFF5EE] shadow-lg'
    >
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          >
  <img src="/assest/logo.png" alt="logo" className='h-[125%] w-full mt-[-0.5rem]' />
