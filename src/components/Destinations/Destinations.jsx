...
import { SparklesIcon , ClockIcon,  } from '@heroicons/react/solid';
import { MapIcon, FlagIcon,    StarIcon, ScaleIcon , ChartBarIcon } from "@heroicons/react/outline";
...
import Titles from '../expect/Title';
        ...
        <div className="bg-white rounded-lg shadow-lg p-2 md:p-6">
          ...
          {day.highlights && (
            <div className="mt-4 border-t pt-3">
              <h4 className="font-medium mb-2  text-teal-950">Key Highlights</h4>
  ...
  <div className="bg-white rounded-xl p-6 ">
    ...
    {destinations?.maxElevation && (
      ...
      <div className="bg-purple-100 p-2 rounded-lg h-[6rem] w-[10rem] flex items-center justify-center flex-col">
        ...
        <p className="text-sm text-purple-600">{destinations?.startPoint}</p>
      </div>
      ...
      <div className="bg-purple-100 p-2 rounded-lg h-[6rem] w-[10rem] flex items-center justify-center flex-col">
        ...
        <p className="text-sm text-purple-600">{destinations?.difficulty}</p>
      </div>
    </div>
  </div>
...
<div className="text-justify">
            <p className="text-gray-700 mb-6">{ destinations?.travel_description.slice(0,700)}</p>
            <p className="text-gray-700 mb-6">{ destinations?.travel_description.slice(80)}</p>
          </div>
